...
export class UserRepository extends BaseRepository<UserModel> {
  constructor(
    @InjectRepository(UserModel) private userModelRepository: Repository<UserModel>,
  ) {
      super(userModelRepository, UserModel);
  }
  ...
  async updateUser(data: Partial<UserModel>, queryRunner?: QueryRunner): Promise<void> {
